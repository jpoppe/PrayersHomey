...
dotenv.config();
const prayer = __importStar(require("@dpanet/prayers-lib"));
...
async function buildLocationObject() {
    try {
        let prayerConfig = await new prayer.Configurator().getPrayerConfig();
        let prayerManager = await prayer.PrayerTimeBuilder
